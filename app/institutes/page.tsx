...
import About3 from "../../components/Aboutinstitutes";
      ...
      <div className="min-h-screen bg-gradient-to-b bg-[#f0f5f4]">
        ...
        >
          <h6 className="mb-3 text-xl font-bold leading-[1.2] text-[#2A8D5C] sm:text-4xl md:text-[30px] p-2">
            Some warning signs that may indicate a student is struggling from
            mental health issue:
          </h6>
        </div>
        <div
          ...
          <div className="container mx-auto ">
            <div className="flex flex-wrap xl:flex-row ">
              <ServiceCard
                ...
                details="Low concentration: The student may have difficulty focusing on tasks and may be easily distracted."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              <ServiceCard
                ...
                details="Low achievement: The student may have a decline in academic performance."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Less engagement"
                details="Less engagement: The student may show less interest in school activities and may withdraw from social interactions."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Stunted progress"
                details="Stunted progress: The student may show a decline in academic performance."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Less social growth"
                details="Less social growth: The student may show a decline in social skills and may have difficulty in making friends."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Low enthusiasm"
                details="Low enthusiasm: The student may show a lack of interest in school activities and may be less motivated to participate in class."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Appear insecure or frightened"
                details="Appear insecure or frightened: The student may show signs of fear, anxiety, or insecurity."
                icon={
                  <svg
                    width="36"
                    height="36"
              ...
              />
              <ServiceCard
                title="Less participation"
                details="
                Less participation: The student may show a decline in participation in class and may be less engaged in school activities.
                "
                icon={
                  <svg
                    width="36"
