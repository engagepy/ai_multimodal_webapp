...
export const Mapping = () => {
  return (
    <>
    <div className="mt-6">
  <h3 className="my-4 text-xl font-bold text-white md:text-3xl text-center">
    AI Efficiency Mapping
  </h3>
  ...
  <thead className="text-xs uppercase text-white bg-[#0A2342]">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Reduces response time to student inquiries from hours to seconds
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Adapts to growing number of users without performance loss
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Offers instant feedback for continuous learning improvement
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Allows personalization according to institutional needs
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Enables flexible, anywhere access to resources
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Continuously improves processes based on data analysis
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Anticipates future trends and behaviors
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Tracks user interactions to refine features
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Delivers detailed reports for performance tracking
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Accommodates global users with diverse language options
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Provides round-the-clock support for uninterrupted service
      </td>
      <td className="py-4 px-6 text-white">
    ...
    <tr className="bg-[#CB7723] border-b border-gray-700">
      ...
      <td className="py-4 px-6 text-white">
        Incorporates advanced security protocols to safeguard data
      </td>
      <td className="py-4 px-6 text-white">
